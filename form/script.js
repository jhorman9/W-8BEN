...
fisicalEntity.addEventListener("change", (e) => {
    ...
    if(fisicalEntityValue && fisicalEntityValue == 'fisical'){
        ...
        console.log(fisicalEntityValue);
    }else{
...
checkEntity && (
    checkEntity.forEach(check => {
        check.addEventListener("change", (e) => {
            ...
            console.log(lastChecked.id)

            if(lastChecked.id == 'financial-institution' || lastChecked.id == 'patrimonial-entity'){
                return(
                    Swal.fire({
                        title: 'Información importante',
                        html: `Por las particularidades de su situación, su caso no puede ser cubierto por las funciones de esta plataforma. Le sugerimos contactarnos directamente a <strong>info@giin.tax</strong> para brindarle asesoría personalizada en el llenado de sus formularios. Tenga en cuenta que para este servicio se aplicarán honorarios profesionales. Estaremos encantados de atenderle.`,
                        icon: 'info',
